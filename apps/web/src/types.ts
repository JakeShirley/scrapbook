...
export type StickerPack = Awaited<ReturnType<typeof apiClient.listStickerPacks>>["packs"][number];
export type CustomSticker = Awaited<
  ReturnType<typeof apiClient.listCustomStickers>
>["stickers"][number];
