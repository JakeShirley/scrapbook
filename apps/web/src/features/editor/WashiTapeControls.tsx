import { renderPageDocumentSvg, type WashiTapeLayer } from "@scrapbook/editor-core";
...
export function WashiTapeControls({
  ...
  resolveHref?: ((layer: WashiTapeLayer) => string | null | undefined) | undefined;
}) {
  ...
  const previewSvg = useMemo(() => {
    const previewLayer: WashiTapeLayer = {
      ...layer,
      x: 48,
      y: 116,
      width: 544,
    ...
    return renderPageDocumentSvg(
      ...
      },
      {
        ...
        ...(resolveHref ? { resolveWashiTapeHref: resolveHref } : {}),
      },
    );
  }, [layer, previewId, resolveHref]);

  return (
    <fieldset className="inspector-section washi-tape-controls-section">
      <legend>Washi tape</legend>
      <div className="washi-tape-controls-layout">
        <div className="washi-tape-preview-pane" role="img" aria-label="Washi tape preview">
          <div
            className="washi-tape-preview-surface"
